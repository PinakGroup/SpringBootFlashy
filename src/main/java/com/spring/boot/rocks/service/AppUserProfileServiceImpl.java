...
public class AppUserProfileServiceImpl implements AppUserProfileService {
	...
	@Override
	public AppUserProfile findById(Long l) {

		Optional<AppUserProfile> appUserProfile = appUserProfileRepository.findById(l);
	...
	public AppUserProfile saveAppUserProfile(AppUserProfile appUserProfile) {
		...
		appUserProfile.setUser(appUserJPARepository.findByUsername(getPrincipal()));
